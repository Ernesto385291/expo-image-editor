...
>
<Text style={{ fontWeight: '500', color: 'white', fontSize: 18 }}>Descartar</Text>
</TouchableOpacity>
...
>
<Text style={{ fontWeight: '500', color: '#27262C', fontSize: 18 }}>Cortar</Text>
</TouchableOpacity>
      </View> : 
      <View
      style={{
...
>
<Text style={{ fontWeight: '500', color: '#27262C', fontSize: 18 }}>Añadir</Text>
</TouchableOpacity>
    </View> 
                     }
                </View>
